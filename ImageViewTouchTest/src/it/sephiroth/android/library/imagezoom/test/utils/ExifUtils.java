	...
	public static int getExifOrientation( Context context, Uri uri ) {
		...
		if ( scheme == null || ContentResolver.SCHEME_FILE.equals( scheme ) ) {
			...
			if ( provider != null ) {
				Cursor result;
				try {
					result = provider.query( uri, new String[] { Images.ImageColumns.ORIENTATION, MediaColumns.DATA }, null,
							null, null );
				} catch ( Exception e ) {
					e.printStackTrace();
					return 0;
				...
				int dataColumnIndex = result.getColumnIndex( MediaColumns.DATA );
