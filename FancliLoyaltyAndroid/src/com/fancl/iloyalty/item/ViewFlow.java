...
public class ViewFlow extends AdapterView<Adapter> {
	...
	private Boolean isQnaQuestion = false;
...
//				}
	...
	private void snapToScreen(int whichScreen) {
		...
		LogController.log("delta-scroll:"+delta);
		invalidate();
	}
	...
	private void setVisibleView(int indexInBuffer, boolean uiThread) {
		...
		mScroller.startScroll(mScroller.getCurrX(), mScroller.getCurrY(), dx,
				0, 0);
		LogController.log("mScroller.getCurrX():"+mScroller.getCurrX());
		LogController.log("dx-scroll:"+dx);
		if(dx == 0)
...
//		mCurrentAdapterIndex++;
//		mScroller.startScroll(getScrollX(), 0, 327, 0);
//		invalidate();
		postViewSwitched(1);
...
//		invalidate();
	...
	public void setIsQnaQuestionPage() {
		isQnaQuestion = true;
