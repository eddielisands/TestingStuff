...
public class ProductSubCategoryListAdapter extends BaseAdapter{
	...
	public ProductSubCategoryListAdapter (Context context, Activity activity, Handler handler) {
...
//				LogController.log("set data product");
			}
		}
	...
	private void setListBarDescriptionTextTcView(
		...
		listBarDescriptionTextTcView.setText(localeService.textByLangaugeChooser(context, product.getTitleZh(), product.getTitleZh(), product.getTitleSc()));
